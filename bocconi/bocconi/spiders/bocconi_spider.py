...
class BocconiSpider(scrapy.Spider):
    name = 'bocconi_spider'
    start_urls = [
        #finance 'http://didattica.unibocconi.eu/docenti/proff_ord_ruolo.php?dip=53&urlBack=/wps/wcm/connect/Bocconi/SitoPubblico_EN/Navigation+Tree/Home/Faculty+and+Research/Departments/Finance/Faculty/',
        #econ 'http://didattica.unibocconi.eu/docenti/proff_ord_ruolo.php?dip=52&urlBack=/wps/wcm/connect/Bocconi/SitoPubblico_EN/Navigation+Tree/Home/Faculty+and+Research/Departments/Ettore+Bocconi+Dep+of+Economics/All+Bocconi+Professors/',
        #acc: 'http://didattica.unibocconi.eu/docenti/proff_ord_ruolo.php?dip=51&urlBack=/wps/wcm/connect/Bocconi/SitoPubblico_EN/Navigation+Tree/Home/Faculty+and+Research/Departments/Accounting/Faculty/',
